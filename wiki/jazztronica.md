# Jazztronica (재즈트로니카) — Line 5

우리 채널의 다섯 번째 브랜드 라인.
**재즈 화성 + 일렉트로닉 프로덕션**을 한 우산에 담는다. 로파이 재즈홉(다운템포)부터 재즈하우스(비트)까지 포괄.

- **Line 1:** Cafe Jazz / Noir (여성 보컬, 빈티지 어쿠스틱)
- **Line 2:** Soul Funk (남성 바리톤)
- **Line 3:** Gospel
- **Line 4:** Neo Soul
- **Line 5:** Jazztronica ⭐ (本 문서)

---

## 장르 정의

사용자가 즐겨 듣는 일본 재즈/일렉트로닉 아티스트 풀에서 출발. **두 갈래 결(A/B)을 한 앨범 안에서 하이브리드 큐레이션**한다.

| 결 | 대표 아티스트 | BPM | 느낌 | 용도 |
|---|---|---:|---|---|
| **A. 재즈하우스 (비트)** | DAISHI DANCE, FreeTEMPO, DJ Kawasaki | 100~122 | 4/4 하우스, 라운지, 드라이브 | 주간·드라이브·업비트 카페 |
| **B. 재즈홉/로파이 (다운템포)** | Nujabes, DJ Okawari | 70~92 | 힙합 비트 + 재즈 샘플 | 공부·휴식·심야 카페 (최대 시장) |
| **C. 시부야케이 (레트로 팝)** | Pizzicato Five 등 (장르) | 다양 | 보사·라운지·팝 콜라주 | 석양·노스탤지어 액센트 |

⚠️ **시부야케이는 아티스트가 아니라 장르** (90s 일본 라운지·팝 무브먼트).

---

## 🎯 전략: 신박 밈 썸네일 + 블루오션 사운드 (2026-05-25 전환)

- **썸네일·제목** = **부조리 밈/무자막 길** (Café del Mar 석양·SEO 클리셰 폐기). 패턴 인터럽트로 차별화. → [[#썸네일--제목-신박-전략-밈부조리-길]]
- **사운드** = 일본 재즈하우스/로파이로 차별화 (블루오션)
- **핵심 발견:** 로파이 재즈홉(B결)이 카페·공부 BGM 최대 시장. Nujabes 계열은 본진. 이 청중은 "예쁜 것"보다 **"웃기고 이상한 것"** 에 더 반응.
- **니치:** FreeTEMPO/Jazztronik 결 전용 BGM 양산 채널 비어있음 + 밈 썸네일은 제작 저비용·바이럴·경쟁 적음 (이중 블루오션)
- **트레이드오프:** 밈/공백제목은 SEO 검색 유입 약함 → 콜드스타트는 구어체 한 줄 제목으로 보완
...
### 아티스트 풀
- **Nujabes** — 로파이 재즈홉 원조 (Feather, Counting Stars, Luv(sic))
- **DJ Okawari** — 재즈홉/인스트루멘탈 (Flower Dance, Luv Letter)
- **DJ Kawasaki** — 재즈하우스/소울풀 하우스 (Brand New Day, Spice of Life)
- **FreeTEMPO** — 오가닉 하우스/누자즈/칠아웃 (tide, sky high, couleur)
- **DAISHI DANCE** — 멜로딕 피아노 하우스 (Joyful, Sunrise)
- **시부야케이** — 레트로 라운지 팝 (Pizzicato Five: Sweet Soul Revue)

### 썸네일 벤치마킹 채널 ⭐ (신박 밈 전략 — 2026-05-25 채택)
사용자 발굴. Café del Mar식 석양·럭셔리 클리셰의 **정반대 길** = 부조리 밈 썸네일.

- **wahaha-muzik** — https://www.youtube.com/@wahaha-muzik
  - 썸네일: **오랑우탄이 아디다스 트랙탑 입고 배달 스쿠터 주행** (실사, 바랜 빈티지 화질)
  - 제목: 구어체 한 줄 ("재즈하우스 배달이요")
  - 후크: 유머·부조리 ("이게 뭐야?"로 스크롤 정지)
- **Lounge4ever** — https://www.youtube.com/@Lounge4ever
  - 썸네일: **백발 할머니가 주유소를 슈퍼맨 자세로 비행** (VHS·글리치·색수차, 모션블러)
  - 제목: **완전 공백(빈칸)**
  - 후크: 궁금증·미스터리 (제목 없음이 플렉스)

### ❌ 폐기: Café del Mar 계열 (2026-05-25)
석양·럭셔리·SEO 키워드 결은 레드오션 + Jazztronica 음악 결과 불일치로 폐기.
(참고만: @cafedelmar / @chilloutloungebar / Schwarz & Funk)

---

## 🎬 썸네일 + 제목 신박 전략 (밈/부조리 길)

석양·키워드 공식 폐기. **패턴 인터럽트(유머·부조리·궁금증)로 스크롤을 멈춘다.**

### 썸네일 공식
```
[일상적 배경] + [이질적 피사체] + [부조리한 행동] + [바랜/VHS 실사 톤] + [무자막]
```

| 요소 | 소재 풀 |
|---|---|
| 피사체 | 동물(오랑우탄·고양이·개)이 인간 옷, 노인, 인형, 마스코트 |
| 행동 | 배달·주유·출근·버스대기 등 **평범한 일상** (이질감 극대화) |
| 합성 | 인물 비행·거대화·공중부양 등 초현실 |
| 배경 | 주유소·편의점·시골길·버스정류장 (레트로 일상) |
| 화질 톤 | 바랜 실사 / VHS 글리치 / 색수차 / 모션블러 |
| 텍스트 | **무자막 원칙** (글자 넣을 거면 구어체 한 줄만) |

### 제목 공식 (SEO 버림)
| 방식 | 예시 | 비고 |
|---|---|---|
| **구어체 한 줄** ⭐ | "재즈하우스 배달이요" / "심야 주유소에서 듣는 노래" | 콜드스타트 보완 (권장) |
| **완전 공백** | (빈칸) | 미스터리 극대화, 채널 궤도 오른 뒤 |

⚠️ **트레이드오프:** 무자막·공백제목은 SEO 검색 유입 0 → 초반은 알고리즘 추천·썸네일 클릭에 전적 의존. 콜드스타트 단계에선 **구어체 한 줄 제목**으로 시작, 궤도 오르면 공백 실험.

---

## 🎵 하이브리드 큐레이션 공식 (10곡 에너지 아크)

**"고BPM → 저BPM"** — 118 BPM 피아노 하우스로 열고 → BPM 순차 하강 → 70 BPM 누자베스로 마감.
고에너지 오프닝 → 점진적 이완 → 누자베스 두 트랙으로 조용히 닫는 구조 (2026-05-26 재편).

| # | 아티스트 | 서브스타일 | BPM | 보컬 | Phase |
|---|:---:|---|---:|:---:|:---:|
| 01 | DAISHI DANCE | Piano House | 118 | 연주 | 起 |
| 02 | DJ Kawasaki | Jazz House | 110 | 연주 | 起 |
| 03 | FreeTEMPO | Organic House 하강 | 106 | 연주 | 承 |
| 04 | FreeTEMPO | Organic House | 102 | 🎤 보컬 | 承 |
| 05 | Shibuya-kei | Shibuya-kei Jazz | 92 | 연주 | 轉 |
| 06 | FreeTEMPO | Downtempo→Organic | 90 | 연주 | 轉 |
| 07 | Nujabes×랩 | Lo-Fi 랩/읊조림 | 80 | 🎤 보컬 | 轉 |
| 08 | DJ Okawari | Neo Soul | 78 | 🎤 보컬 | 結 |
| 09 | Nujabes | Lo-Fi Jazz-Hop | 72 | 연주 | 結 |
| 10 | Nujabes | Lo-Fi Jazz-Hop | 70 | 연주 | 結 |

**규칙:**
- 보컬 3곡(04·07·08) + 연주 7곡. 시작(01)·끝(10)은 연주로 감싼다.
- BPM 고→저 순차 하강. 전곡에 가사 넣지 않는다 (BGM 유지).
- T09·T10 누자베스 페어로 마감.
...
```
[Jazzy Deep House] / [Organic Jazz House] / [Melodic Piano House]
...
## 🎥 영상 파형 스펙 (서클형 · 2026-05-25 확정)

Jazztronica 라인 파형은 **서클형(방사 바)** 으로 통일.
⚠️ **적용 시점:** **Vol.02부터 서클** 적용 (사용자 확정 2026-05-25). **Vol.01은 cafe-line 얇은 선 버전 유지** (이미 렌더 완료, 재렌더 안 함).

| 항목 | 값 |
|---|---|
| 컴포지션 | `SF-Pack-radial-bars` (중앙 이너 링 + 128 방사 바) |
| 색 | accentColor `#F5F0E4` / secondaryColor `#F5F0E4` (크림) |
| 배경 | transparent (알파 오버레이) |
| 해상도 | 1280×720 / 30fps |
| 코덱 | ProRes 4444 / yuva444p10le / PNG |
| durationInFrames | 8000 (긴 곡 커버 — [[soulfunk-waveform-radial-mild]] 참조) |
| 진폭 배율 | 1.2x (mild) / 회전 5°/s |

- 렌더 커맨드/배치: `사용한 곡/playlist-video/YYMMDD/batch-jazztronica-volNN.sh`
- props: `{"audioSrc":"jz-NN.mp3","variant":"radial-bars","bgColor":"transparent","accentColor":"#F5F0E4","secondaryColor":"#F5F0E4"}`
- ⚠️ Cafe BGM(`SoulFunk-Wave-Cafe` 얇은 선)과 구분 — Jazztronica는 **서클 전용**
...
### ✅ 테스트 진행상황 (2026-05-26 트랙 재배치 후 전체 리셋)
- ⬜ 01 DAISHI DANCE (연주) — 미테스트
- ⬜ 02 DJ Kawasaki (연주) — 미테스트
- ⬜ 03 FreeTEMPO (연주) — 미테스트
- ⬜ 04 FreeTEMPO (보컬) — 미테스트
- ⬜ 05 Shibuya-kei (연주) — 미테스트
- ⬜ 06 FreeTEMPO (연주) — 미테스트
- ⬜ 07 Nujabes 랩 (보컬) — 미테스트
- ⬜ 08 DJ Okawari (보컬) — 미테스트
- ⬜ 09 Nujabes (연주) — 미테스트
- ⬜ 10 Nujabes (연주) — 미테스트
...
- ✅ 보컬 3곡(04·07·08) 전부 표준 Verse 3 구조 통일 (`V1›V2›Chorus›Bridge›Verse3›Final Chorus›Outro`)
...
## 다음 단계
- [ ] Suno 10곡 생성 (사용자) — 보컬곡 A/B 테스트 먼저
- [ ] 썸네일 밈 소재 제작/수집 (동물+인간옷, 초현실 합성, VHS톤)
- [ ] 제목 결정 (구어체 한 줄 vs 공백)
- [ ] wahaha-muzik / Lounge4ever 업로드 주기·영상 길이·조회수 정밀 박제
- [ ] 설명글 템플릿

---

최종 업데이트: 2026-05-25 (**신박 밈 썸네일 전략 전환** — Café del Mar 석양·SEO 결 폐기 → 부조리 밈/무자막/공백제목 채택 · 벤치마크 wahaha-muzik + Lounge4ever 박제 · 썸네일 소재 풀 + 제목 공식 신설 / **Verse 3 구조 전곡 보컬 통일** — 하우스 트랙 04·06 Hook 구조 폐기 → `V1›V2›Chorus›Bridge›Verse3›Final Chorus›Outro`로 통일 / Line 5 Jazztronica 신설 — 하이브리드 큐레이션 공식 + Vol.01 Tokyo Cafe Day 10곡 + 아티스트 작명 DNA + Tokyo 앵커 제목 공식)
